...
<head>
    <meta charset="utf-8">
    <title>VIRTUAL ACADEMY BILL</title>
    <style>
    .invoice-box {
        max-width: 100%;
        margin: auto;
...
<body>
    <div class="invoice-box">
        ...
        $sql = "select * from virtual_transaction where id='".$bid."' and skey='".$skey."'";
        $q = $conn->query($sql);
        if($q->num_rows>0)
        {
        $res=$q->fetch_assoc();
        ...
        ?>
         <div class="top">
               <img src="img/Virtual.png" style="width:100%;max-height:200px;"/>
           </div>
        <table cellpadding="0" cellspacing="0">
                    ...
                    <table>
                        <tr>
                            <td>
                               ...
                               <?php echo $place ?>
                               <br>
                               ADMISSION NO : <?php echo $admissionno ?>
                               <br>
           ...
           <tr>
           <td>Secondary Fee</td>
           <td><?php echo $secondaryfee;?></td>
           </tr>
           <tr>
           <td>Sr. Secondary Fee</td>
           <td><?php echo $seniorsecondary;?></td>
           </tr>
           <tr>
           <td>UG Fee</td>
           <td><?php echo $ugfee;?></td>
           </tr>
           <tr>
           <td>PG Fee</td>
           <td><?php echo $pgfee;?></td>
           </tr>
           <tr>
           <td>Diploma/PG Diploma Fee</td>
           <td><?php echo $diplomafee;?></td>
           </tr>
           <tr>
