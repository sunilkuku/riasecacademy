...
$contact = $sr['contact'];
$tbalance=$sr['balance'];
$sql = "insert into virtual_transaction(stdid,submitdate,admissionfee,secondaryfee,seniorsecondary,ugfee,pgfee,diplomafee,regfee,examfee,materialsfee,miscellaneousfee,transcation_remark,paid,total_deduction,totalamount,skey) values('$sid','$submitdate','$admissionfee','$secondaryfee','$seniorsecondary','$ugfee','$pgfee','$diplomafee','$regfee','$examfee','$materialsfee','$miscellaneousfee','$transaction_remark','$paid','$tdeduction','$totalamount','$skey')";
$conn->query($sql);
$tbalance =$tbalance+($totalamount- $paid) ;
$sql = "update student set balance='$tbalance' where id = '$sid'";
$conn->query($sql);
 echo '<script type="text/javascript">window.location="virtualpayment.php?act=1";</script>';}
 else{
  echo '<script type="text/javascript">window.location="virtualpayment.php?act=2";</script>';
}
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Vitual Academy Payment  
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Course</th><th>Balance</th><th>College/School</th><th>DOJ</th><th>Action</th></tr></thead><tbody></tbody></table>');
			    ...
			    $("#tSortable22").dataTable({
                  ...
                  "bInfo": false,
							       'bProcessing' : true,
							       'bServerSide': true,
							       'sAjaxSource': "datatable.php?"+$('#searchform').serialize()+"&type=virtualfeesearch",
							       'aoColumnDefs': [{
                                   'bSortable': false,
...
////////////////////////////
 $("#tSortable22").dataTable({
                  ...
                  'bProcessing' : true,
				  'bServerSide': true,
                  'sAjaxSource': "datatable.php?type=virtualfeesearch",
