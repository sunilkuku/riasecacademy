...
$detail = mysqli_real_escape_string($conn,$_POST['detail']);
 ...
 if($_POST['action']=="add")
 {
  ...
  $sql = $conn->query("INSERT INTO branch (branch,address,detail) VALUES ('$branch','$address','$detail')") ;
    ...
    echo '<script type="text/javascript">window.location="department.php?act=1";</script>';
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   ...
   echo '<script type="text/javascript">window.location="department.php?act=2";</script>';
 }
...
header("location: department.php?act=3");
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						' <a href="department.php" class="btn btn-primary btn-sm pull-right">Back <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="department.php?action=add" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Add </a>';
						?>
						</h1>
		...
		?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<form action="department.php" method="post" id="signupForm1" class="form-horizontal">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Department Name</label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">Responsabilities </label>
								<div class="col-sm-10">
                             ...
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr>
                                            ...
                                            <td>'.$r['detail'].'</td>
											<td>
											<a href="department.php?action=edit&id='.$r['id'].'" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span></a>
											
                                        </tr>';
										$i++;
									}
									?>
																				<!-- <a onclick="return confirm(\'Are you sure you want to delete this record\');" href="department.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a> </td> -->
